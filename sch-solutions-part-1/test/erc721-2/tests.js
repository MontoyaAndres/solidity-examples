...
describe("ERC721 Tokens Exercise 2", () => {
  ...
  it("Deployment & Listing Tests", async () => {
    ...
    for (let i = 1; i <= 10; i++) {
      ...
      await this.marketplace
        .connect(user1)
        .listItem(this.cuteNFT.address, i, CUTE_NFT_PRICE);
    }
    ...
    for (let i = 1; i <= 5; i++) {
      ...
      await this.marketplace
        .connect(user3)
        .listItem(this.booblesNFT.address, i, BOOBLES_NFT_PRICE);
    }
